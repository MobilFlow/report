...
| :---- | :---- | :---- |
| **Criterio 1:** Actualiza conceptos y conocimientos necesarios para su desarrollo profesional y en especial para su proyecto en soluciones de ingeniería de software | **Gabriel Sanchez**  <br>  **AV1:** Descripción del startup; entrevistas a usuarios; diseño de user personas; elaboración de empathy mapping; definición de ubiquitous language; creación del product backlog; desarrollo de event storming  <br>  **TB1:** En este avance desarrolle correcciones del AV1, desarrollo de la API de geolocalización CRUD, desarrollo de la API de IAM CRUD, desarrollo del sprint planning 1, desarrollo del sprint backlog 1, desarrollo del development evidence for sprint review, desarrollo del testing suite evidence for sprint review, desarrollo de execution evidence for sprint review, desarrollo de servicios, services documentation evidence for sprint review, preguntas para validation interviews, registro de 3 validation interviews, desarrollo de evaluación según heurísticas  <br> **TP:** Desarrollo de Aplicación en Flutter, Desarrollo de correciones de pantallas y nuevas pantallas faltantes en Kotlin e integración de flujo, Documentación de Sprint 2  <br> **TB2:** Desarrollo de Aplicación en Flutter, Desarrollo de correciones de pantallas y nuevas pantallas faltantes en Kotlin e integración de flujo, Deployment Evidence, Team Collaboration Insight<br> **Braulio Torrejon**  <br>  **AV1:** Cargo archivos; entrevistas a usuarios; elaboración de user stories; candidate context discovery; domain message flow modeling; bounded context canvases; definición de software architecture; desarrollo de impact mapping  <br>  **TB2:** Desarrollo de bounded contexts Carrier y Vehicle; implementación de entidades de dominio, comandos y queries; desarrollo de Controllers REST, Resources y Assemblers; implementación de endpoints CRUD mediante Spring Boot; elaboración de OpenAPI Documentation; configuración y validación de Swagger UI; integración entre frontend y backend; corrección de errores de compilación y dependencias; desarrollo de Software Architecture Documentation; elaboración de Sprint Planning 2, Sprint Backlog 2, Development Evidence for Sprint Review, Testing Suite Evidence for Sprint Review y Services Documentation Evidence for Sprint Review.  <br> **TB2:** Desarrollo del flujo de diagnóstico inteligente y recomendación de mecánicos, implementando el motor de diagnóstico y matching en el backend, así como su integración con Android.  <br>  **Romina Tuesta**  <br>  **AV1:** Realicé todo el punto 2.6 diagrama de clase, base de datos y contenedores C4 y la estructuración de layers. <br> **TP:** He podido ampliar mis conocimientos en desarrollo movil, con el desarollo de diferentes vistas, pantallas, navegación, etc.  <br>  **AV2:**  Se integraron conocimientos sobre servicios basados en inteligencia artificial, implementando y optimizando un módulo de recomendación utilizando una API externa de IA para generar respuestas inteligentes dentro del proyecto. <br> **TB2:** Se aplicó el enfoque BDD (Behavior Driven Development) para comprender la elaboración de pruebas de aceptación mediante archivos `.`feature utilizando lenguaje Gherkin y su relación con las historias de usuario del proyecto. <br>  **Giussepe Taquiri**  <br>  **AV1:** Análisis competitivo; definición de estrategias y tácticas frente a competidores; elaboración de User Task Matrix; desarrollo de User Journey Mapping  <br>  **TB1:** Desarrollo de Product Design, Style Guidelines, Information Architecture, Organization Systems, Labelling Systems, SEO Tags and Meta Tags, Searching Systems, Navigation Systems, Software Configuration Management, Software Development Environment Configuration, Source Code Management, Source Code Style Guide & Conventions y Software Deployment Configuration.  <br>  **AV2:** Desarrollo e integración del módulo de Calificación y Reputación, implementación de endpoints de reviews, ratings y reputation summary, conexión de las pantallas de reputación con el backend, integración del perfil de mecánico con datos reales de la API, visualización de reseñas y calificaciones, validación del flujo de perfiles de conductor. <br>   **TB2:** Elaboración del Sprint Planning 3 y Sprint Backlog 3; implementación de la integración final del módulo de Calificación y Reputación; optimización de la visualización de reseñas, calificaciones y perfil del mecánico; corrección de incidencias de integración entre frontend y backend; actualización de la documentación técnica de los servicios; ejecución de pruebas funcionales y validación de la versión final de la aplicación para el Release.  <br>  **Liam Villugas**  <br>  **AV1:** entrevistas a mecanicos; Elaboracion de Antecedentes y problematica; Lean UX Problem Statements; Lean UX Assumptions; Lean UX Hypothesis Statements; Lean UX Canvas; desarrollo de Context mapping  <br>  **TB1:** Realicé entrevistas a mecánicos para análisis de requerimientos, desarrollo de servicios backend enfocados en service request (CRUD y lógica de solicitudes), desarrollo de vistas frontend para conductores, implementación de pantallas de solicitud de servicio y seguimiento, validación de flujos de usuario conductor, registro de hallazgos en entrevistas, y documentación técnica de los servicios implementados.  <br>  **AV2:** Identifiqué y corregí endpoints incorrectos en el consumo de la API REST, implementé la creación automática del perfil de conductor tras el registro de usuario, desarrollé el registro de vehículos con campos completos (marca, modelo, año, placa y tipo de combustible), adapté el campo de combustible de texto libre a un selector basado en un enum del backend (GASOLINE, DIESEL, HYBRID, ELECTRIC, GAS), y agregué logs de depuración para diagnosticar fallos silenciosos en las llamadas HTTP.  <br>  **TB2:** Documenté todos los endpoints del backend a partir de la especificación OpenAPI, elaborando una tabla completa con método HTTP, ruta, descripción, cuerpo de solicitud y respuesta esperada para cada servicio (autenticación, usuarios, conductores, mecánicos, servicios, solicitudes de servicio, ubicaciones, reputación, categorías y búsqueda). Además, capturé evidencia de ejecución de la aplicación móvil completamente funcional, verificando que todas las pantallas conectadas al backend real muestren los datos correctamente (perfil de conductor, registro de vehículos, listado de vehículos y solicitudes de servicio). | **Gabriel Sanchez**  <br>  **AV1:** Durante este avance desarrollé la descripción completa del startup, realicé entrevistas a usuarios, diseñé user personas y empathy maps, construí el ubiquitous language, elaboré el product backlog y llevé a cabo el event storming. <br>  **TB1:** Apliqué la actualización de mis conocimientos mediante la corrección del AV1 y el desarrollo de APIs CRUD como IAM y geolocalización, fortaleciendo mis habilidades en backend y arquitectura de servicios. También reforcé mi aprendizaje con la planificación del sprint, evidencias de desarrollo y testing, validaciones mediante entrevistas y evaluación de heurísticas dentro del proyecto de ingeniería de software.   <br><br> **TP:**Fortalecí la actualización de mis conocimientos a través de la revisión y mejora del AV1, además de la implementación de APIs CRUD relacionadas con IAM y geolocalización, lo que permitió mejorar mis competencias en desarrollo backend y diseño de arquitectura de servicios. Asimismo, consolidé mi aprendizaje mediante la planificación del sprint, la recopilación de evidencias de desarrollo y pruebas, junto con la validación de funcionalidades a través de entrevistas y la aplicación de evaluaciones heurísticas dentro del proyecto de ingeniería de software.  <br> **TB2:** Durante el desarrollo del proyecto, actualicé mis conocimientos en desarrollo móvil mediante la implementación de funcionalidades en Flutter, la corrección y creación de nuevas pantallas en Kotlin, y la integración de flujos dentro de la aplicación. Además, reforcé mis conocimientos sobre despliegue y trabajo colaborativo mediante la generación de evidencias de deployment y la coordinación con el equipo.  <br>  **Braulio Torrejon**  <br>  **AV1:** En este avance consolidé la arquitectura del proyecto mediante entrevistas, user stories y modelado de contextos. Implementé diagramas de flujo de mensajes y bounded contexts, definiendo la arquitectura de software y el impact mapping, lo que permitió dar claridad técnica y trazabilidad al proyecto.  <br>  **TB2:** En este avance fortalecí mis conocimientos en arquitectura de software y desarrollo backend mediante la implementación de bounded contexts, APIs REST y documentación OpenAPI. La aplicación de Spring Boot, Domain-Driven Design y Swagger me permitió mejorar mis habilidades en diseño de servicios, organización de componentes de software y construcción de soluciones escalables para el proyecto MobilFlow.  <br> **TB2:**  Fortalecí mis conocimientos en DDD, CQRS e integración frontend-backend mediante la implementación de funcionalidades que conectan distintos bounded contexts del sistema.  <br>  **Romina Tuesta**  <br>  **AV1:** En este avance pude conocer más acerca de la estructura de los bounded context, realizando los layers como domain, interface, etc., además de adentrarme más a los contenedores de cada bounded.  <br>  **AV2:** Definiendo la arquitectura base con bounded contexts (IAM, matchmaking, servicecatalog, geolocalization, reputation) y la estructura de capas siguiendo principios DDD. <br> **TB2:** Durante el desarrollo del proyecto se fortalecieron y actualizaron conocimientos relacionados con la ingeniería de software, aplicando conceptos actuales como arquitectura basada en contextos, desarrollo de APIs REST, integración entre componentes, pruebas automatizadas y consumo de servicios externos de inteligencia artificial. La implementación de nuevas funcionalidades y la validación mediante pruebas unitarias e integrales permitieron mejorar la calidad del software desarrollado, demostrando la importancia de mantener un aprendizaje continuo para adaptarse a nuevas tecnologías y aplicar buenas prácticas en la construcción de soluciones de software profesionales. <br>  **Giussepe Taquiri**  <br>  **AV1:** Durante este avance desarrollé el análisis competitivo y definí estrategias y tácticas frente a los competidores. Asimismo, elaboré el User Task Matrix y los User Journey Maps, aplicando herramientas de análisis UX para comprender mejor las necesidades del usuario y contribuir a la solución del proyecto. <br>  **TB1:** En este avance fortalecí mis conocimientos en diseño UI/UX, organización de información y configuración de proyectos de software mediante el desarrollo de arquitecturas de navegación, sistemas de etiquetado, gestión de código fuente y configuración de despliegue. Esto me permitió mejorar mis habilidades en documentación técnica y organización de soluciones móviles.  <br>  **AV2:** Durante este avance fortalecí mis conocimientos en desarrollo móvil e integración de servicios backend mediante la implementación del módulo de Calificación y Reputación. La conexión de las pantallas con APIs reales y la validación de flujos funcionales me permitieron mejorar mis competencias en consumo de servicios REST, integración frontend-backend y resolución de problemas dentro de un entorno colaborativo de desarrollo de software.  <br> **TB2:** En este avance consolidé mis conocimientos en desarrollo móvil e integración frontend-backend al completar la implementación del módulo de Calificación y Reputación, optimizar la interacción con servicios REST y participar en la planificación, documentación y validación de la versión final del proyecto. Esto fortaleció mis competencias en trabajo colaborativo, resolución de incidencias y preparación de software para producción.  <br>  **Liam Villugas**  <br>  **AV1:** En este avance consolidé la visión estratégica y técnica de AutoMatch mediante el uso de Lean UX y Domain-Driven Design (DDD). Al integrar las entrevistas a mecánicos con el modelado de Bounded Contexts, logré alinear los objetivos de negocio de MobilFlow con una arquitectura de software escalable. Este proceso me permitió aplicar conocimientos avanzados en ingeniería de software para garantizar la trazabilidad y la correcta delimitación de dominios en la solución. <br>  **TB1:** Apliqué la actualización de mis conocimientos mediante la realización de entrevistas a mecánicos para el análisis de requerimientos, el desarrollo de servicios backend enfocados en service request (solicitudes de servicio), y la implementación de vistas frontend para conductores en la aplicación móvil. Fortalecí mis habilidades en diseño de interfaces centradas en el usuario conductor dentro de la app móvil Automatch.  <br>  **AV2:** Apliqué la actualización de mis conocimientos al leer la especificación OpenAPI del backend para entender los endpoints reales, al implementar correctamente Retrofit con parámetros de ruta y cuerpo, y al utilizar Logcat para depurar errores HTTP y campos nulos. Fortalecí mis habilidades en integración frontend-backend para la aplicación móvil Automatch, comprendiendo la importancia de no asumir que los datos siempre estarán disponibles y de manejar explícitamente los casos de error.  <br>  **TB2:** Apliqué la actualización de mis conocimientos al analizar la especificación OpenAPI completa del backend, comprendiendo la estructura de cada recurso, los tipos de datos esperados y las relaciones entre entidades. Fortalecí mis habilidades en documentación técnica de APIs REST y en validación visual del funcionamiento integral de la aplicación móvil Automatch, asegurando que cada módulo implementado en sprints anteriores opere correctamente en un entorno real. |
| **Criterio 2:** Reconoce la necesidad del aprendizaje permanente para el desempeño profesional y el desarrollo de proyectos en soluciones de tecnologías de ingeniería de software | **Gabriel Sanchez**  <br>  **AV1:** Descripción del startup; entrevistas a usuarios; diseño de user personas; elaboración de empathy mapping; definición de ubiquitous language; creación del product backlog; desarrollo de event storming <br>**TB1:** Correcciones del AV1, desarrollo de la API de geolocalización CRUD, desarrollo de la API de IAM CRUD, desarrollo del sprint planning 1, desarrollo del sprint backlog 1, desarrollo del development evidence for sprint review, desarrollo del testing suite evidence for sprint review, desarrollo de execution evidence for sprint review, desarrollo de servicios, services documentation evidence for sprint review, preguntas para validation interviews, registro de 3 validation interviews, desarrollo de evaluación según heurísticas <br>  **TP:** Desarrollo de Aplicación en Flutter, Desarrollo de correciones de pantallas y nuevas pantallas faltantes en Kotlin e integración de flujo, Documentación de Sprint 2<br>  **TB2:** Desarrollo de Aplicación en Flutter, Desarrollo de correciones de pantallas y nuevas pantallas faltantes en Kotlin e integración de flujo, Deployment Evidence, Team Collaboration Insight<br>  **Braulio Torrejon**  <br>  **AV1:** Cargo archivos; entrevistas a usuarios; elaboración de user stories; candidate context discovery; domain message flow modeling; bounded context canvases; definición de software architecture; desarrollo de impact mapping  <br>  **TP:** Desarrollo y documentación de APIs REST; investigación y aplicación de Swagger/OpenAPI; implementación de buenas prácticas de desarrollo backend; resolución de errores de integración y validación de endpoints; aplicación de patrones Domain-Driven Design (DDD); mejora continua de la arquitectura de software y documentación técnica de los servicios desarrollados.  <br> **TB2:** Investigación y aplicación de comunicación entre bounded contexts mediante ACL, análisis stateless y manejo de estado compartido para implementar el flujo Smart Diagnosis.  <br>  **Romina Tuesta**  <br>  **AV1:** En este avance pude conocer más acerca de la estructura de los bounded context, realizando los layers como domain, interface, etc., además de adentrarme más a los contenedores de cada bounded.  <br> **AV2:** Se integró y optimizó el uso de servicios de inteligencia artificial dentro del sistema, permitiendo generar recomendaciones automáticas según las necesidades ingresadas por los usuarios. <br> **TB2:** Se fortaleció el manejo de herramientas de desarrollo profesional como Maven, JUnit, Mockito, Spring Test, Postman y Swagger, utilizadas para la construcción, documentación y validación del software. <br>  **Giussepe Taquiri**  <br>  **AV1:** Análisis competitivo; estrategias y tácticas frente a competidores; User Task Matrix; User Journey Mapping; uso de herramientas de análisis y gestión  <br>  **TB1:** Desarrollo de Product Design, Style Guidelines, Information Architecture, Organization Systems, Labelling Systems, SEO Tags and Meta Tags, Searching Systems, Navigation Systems, Software Configuration Management, Software Development Environment Configuration, Source Code Management, Source Code Style Guide & Conventions y Software Deployment Configuration.  <br>  **AV2:** Desarrollo e integración del módulo de Calificación y Reputación, implementación de endpoints de reviews, ratings y reputation summary, conexión de las pantallas de reputación con el backend, integración del perfil de mecánico con datos reales de la API, visualización de reseñas y calificaciones, validación del flujo de perfiles de conductor. <br>  **TB2:** Desarrollo del Sprint Planning 3 y Sprint Backlog 3; optimización del módulo de Calificación y Reputación; integración final con servicios REST; actualización de la documentación técnica; validación funcional de los principales flujos de la aplicación; corrección de errores detectados durante la etapa de integración y preparación del Release.   <br>  **Liam Villugas**  <br>  **AV1:** entrevistas a mecanicos; Elaboracion de Antecedentes y problematica; Lean UX Problem Statements; Lean UX Assumptions; Lean UX Hypothesis Statements; Lean UX Canvas; desarrollo de Context mapping  <br>  **TB1:** Realicé entrevistas a mecánicos para análisis de requerimientos, desarrollo de servicios backend enfocados en service request (CRUD y lógica de solicitudes), desarrollo de vistas frontend para conductores, implementación de pantallas de solicitud de servicio y seguimiento, validación de flujos de usuario conductor, registro de hallazgos en entrevistas, y documentación técnica de los servicios implementados. <br>  **AV2:** Implementé la creación automática del perfil de conductor tras el registro de usuario, desarrollé el registro de vehículos con campos completos (marca, modelo, año, placa y tipo de combustible), adapté el campo de combustible de texto libre a un selector basado en un enum del backend (GASOLINE, DIESEL, HYBRID, ELECTRIC, GAS), y agregué logs de depuración para diagnosticar fallos silenciosos en las llamadas HTTP.  <br>  **TB2:** Documenté todos los endpoints del backend a partir de la especificación OpenAPI, elaborando una tabla completa con método HTTP, ruta, descripción, cuerpo de solicitud y respuesta esperada para cada servicio (autenticación, usuarios, conductores, mecánicos, servicios, solicitudes de servicio, ubicaciones, reputación, categorías y búsqueda). Asimismo, realicé la captura de pantallas de la ejecución de la aplicación móvil para evidenciar el correcto funcionamiento de las funcionalidades implementadas durante el ciclo de desarrollo. | **Gabriel Sanchez**  <br>  **AV1:** Este proceso evidenció que el desarrollo de soluciones de software exige aprendizaje constante. Comprendí que debo seguir actualizándome y explorando nuevas metodologías y tecnologías para mejorar la calidad y efectividad de mis proyectos.  <br> **TB1:**Apliqué el aprendizaje permanente al reforzar continuamente mis conocimientos durante el desarrollo del proyecto, investigando y mejorando mis habilidades en APIs, arquitectura de microservicios y pruebas. Esto me permitió adaptarme a nuevas necesidades del sistema y mejorar la calidad de las soluciones implementadas en cada entrega del proyecto de ingeniería de software.  <br>  **TP:** Durante el desarrollo del proyecto, reconocí la importancia del aprendizaje permanente al fortalecer mis conocimientos en tecnologías móviles mediante el desarrollo en Flutter, la corrección e implementación de nuevas pantallas en Kotlin y la integración de flujos de la aplicación. Además, la elaboración de la documentación del Sprint 2 permitió reforzar la importancia de analizar, organizar y comunicar adecuadamente el avance del desarrollo de software.  <br>**TB2:**Durante el desarrollo del proyecto, reconocí la importancia del aprendizaje continuo para adaptarme a nuevas tecnologías y resolver desafíos técnicos. La implementación en Flutter, las correcciones e integración de pantallas en Kotlin y el proceso de despliegue evidenciaron la necesidad de investigar y fortalecer constantemente mis conocimientos para desarrollar soluciones de software eficientes y de calidad. <br>  **Braulio Torrejon**  <br>  **AV1:** Este proceso me permitió reconocer que la construcción de arquitecturas sólidas requiere aprendizaje continuo. La integración de técnicas como EventStorming, DMFM y bounded contexts evidenció la necesidad de seguir perfeccionando metodologías y herramientas para lograr soluciones escalables y auditables.  <br>  **TP:** Este avance me permitió reconocer la importancia del aprendizaje continuo en el desarrollo de soluciones de ingeniería de software. La investigación de nuevas herramientas, la resolución de problemas técnicos y la aplicación de buenas prácticas de arquitectura evidenciaron que la actualización constante de conocimientos es fundamental para desarrollar sistemas mantenibles, escalables y alineados con las necesidades del proyecto MobilFlow.  <br> **TB2:** Comprendí la importancia del aprendizaje continuo para resolver problemas de arquitectura e integración, mejorando mis conocimientos en APIs REST, diseño de software y desarrollo móvil.  <br>  **Romina Tuesta**  <br>  **AV1:** Lo realizado en esta entrega refuerza la necesidad de obtener más conocimiento para llegar a la vida profesional preparados y listos para aplicar lo aprendido.  <br> AV2: Durante la ejecución del proyecto se identificó que la adquisición continua de conocimientos contribuye directamente al desarrollo de soluciones tecnológicas más completas y adaptables. La aplicación de nuevas prácticas como pruebas automatizadas, integración de servicios externos, arquitectura de software y optimización de funcionalidades demuestra que el crecimiento profesional depende de la capacidad de aprender, investigar y aplicar nuevas tecnologías según las necesidades del proyecto. <br> **TB2:** El desarrollo del proyecto permitió reconocer que el aprendizaje permanente es fundamental para el desempeño profesional en ingeniería de software, debido a la constante evolución de tecnologías, frameworks y metodologías de desarrollo. La incorporación de nuevas herramientas, la resolución de problemas técnicos y la mejora continua de los procesos evidencian la importancia de mantenerse actualizado para construir soluciones eficientes y de calidad. <br>  **Giussepe Taquiri**  <br>  **AV1:** Este avance me permitió reconocer la importancia del aprendizaje continuo en el desarrollo de soluciones tecnológicas. A través del análisis competitivo y herramientas UX, comprendí la necesidad de actualizar constantemente mis conocimientos para adaptarme a nuevas tecnologías y metodologías en ingeniería de software. <br>  **TB2:** Durante este avance consolidé mis conocimientos en desarrollo móvil e integración de servicios REST al participar en la planificación del Sprint 3, la optimización del módulo de Calificación y Reputación y la validación funcional de la aplicación. Asimismo, fortalecí mis competencias en integración frontend-backend, documentación técnica, resolución de incidencias y trabajo colaborativo, comprendiendo la importancia del aprendizaje continuo para desarrollar soluciones de software estables, mantenibles y listas para su despliegue.  <br>  **AV2:** Durante este avance fortalecí mis conocimientos en desarrollo móvil e integración de servicios backend mediante la implementación del módulo de Calificación y Reputación. La conexión de las pantallas con APIs reales y la validación de flujos funcionales me permitieron mejorar mis competencias en consumo de servicios REST, integración frontend-backend y resolución de problemas dentro de un entorno colaborativo de desarrollo de software. <br>  **TB2:** Este avance reafirmó la importancia del aprendizaje continuo durante el desarrollo de software. La integración de servicios, la solución de problemas reales entre frontend y backend, y la actualización constante de la documentación me permitieron fortalecer mis habilidades técnicas y comprender la necesidad de mejorar continuamente para desarrollar aplicaciones móviles mantenibles y de calidad.  <br>  **Liam Villugas**  <br>  **AV1:** El desarrollo de AutoMatch evidencia que la ingeniería de software exige un aprendizaje permanente para dominar marcos como Lean UX y DDD. La complejidad del ecosistema de MobilFlow reafirma que la actualización constante en metodologías y arquitecturas es indispensable para resolver problemas reales y mantener la competitividad profesional en el diseño de soluciones tecnológicas. <br>  **TB1:** Apliqué el aprendizaje permanente al investigar continuamente sobre buenas prácticas en desarrollo de servicios REST, manejo eficiente de solicitudes (service request), y diseño de interfaces móviles para conductores. Durante el desarrollo del proyecto, reforcé mis competencias en tecnologías backend y frontend, adaptándome a nuevos requerimientos surgidos de las entrevistas con mecánicos y mejorando la calidad de las vistas del conductor en cada iteración de la app móvil. <br>  **AV2:** Apliqué la actualización de mis conocimientos al leer la especificación OpenAPI del backend para entender los endpoints reales, al implementar correctamente Retrofit con parámetros de ruta y cuerpo, y al utilizar Logcat para depurar errores HTTP y campos nulos. Fortalecí mis habilidades en integración frontend-backend para la aplicación móvil Automatch, comprendiendo la importancia de no asumir que los datos siempre estarán disponibles y de manejar explícitamente los casos de error. <br>  **TB2:** Apliqué el aprendizaje permanente al profundizar en la lectura e interpretación de especificaciones OpenAPI, comprendiendo cómo se estructuran los contratos de servicio entre frontend y backend. Durante esta etapa, reforcé la importancia de mantener una documentación técnica actualizada como base para el mantenimiento y evolución del proyecto, y confirmé mediante evidencia visual que la aplicación móvil Automatch cumple con los requerimientos funcionales definidos, integrando correctamente todas las capas del sistema. |
...
<img src="/assets/asset/DB5.png" style="max-width:700px; max-height:800px; width:auto; height:auto;">
...
[Link a Prototipo](https://www.figma.com/proto/ZX2IFwBkBBCBVVkt5pc7L0/MockUps---Wireframes?node-id=40-2&t=4GQMqj5153TJ8DPf-1&scaling=scale-down&content-scaling=fixed&page-id=1%3A2&starting-point-node-id=11%3A55)

<img src="assets/images/prototype.png" width="100%">
...
Durante este Sprint el equipo se enfocó en la estabilización de la plataforma **AutoMatch**, realizando la integración final de los módulos desarrollados, corrigiendo las incidencias detectadas durante las pruebas, optimizando el rendimiento de la aplicación móvil y actualizando la documentación técnica del proyecto. Asimismo, se preparó la versión final para su despliegue y validación, con el objetivo de garantizar el correcto funcionamiento de las funcionalidades implementadas.

**Link a Trello:** https://trello.com/invite/b/6a068841acbe1487bd955d97/ATTI93e02f577752f14ff38f789bc8fc666eCFE5AB80/automathc

| User Story Id | User Story Title | Work-Item / Task Id | Work-Item / Task Title | Description | Estimation (Hours) | Assigned To | Status |
| :---- | :---- | :---- | :---- | :---- | :---- | :---- | :---- |
| US-25 | Optimizar experiencia de usuario | TK-01 | Corrección de incidencias de la interfaz | Ajuste de interfaces y mejora de la experiencia de usuario | 6 | Gabriel Sanchez | Done |
| US-26 | Mejorar integración móvil | TK-02 | Integración final entre Backend y Frontend | Corrección de errores de integración entre la API y la aplicación móvil | 8 | Giussepe Taquiri | Done |
...
| TS-12 | Documentación de la API | TK-05 | Actualizar documentación de Swagger | Incorporación de los nuevos endpoints implementados | 5 | Braulio Torrejon | Done |
| US-16 | IA de recomendación | TK-06 | Optimizar recomendaciones de IA | Ajustes en las respuestas del asistente inteligente | 6 | Romina Tuesta | Done |
| US-11 | Lista de mecánicos | TK-07 | Optimización de la carga de información | Mejora de los tiempos de respuesta en las consultas de mecánicos | 6 | Liam Villugas | Done |
